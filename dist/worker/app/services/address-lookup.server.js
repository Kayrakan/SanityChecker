async function lookupViaZippopotam(countryCode, postalCode) {
...
async function lookupViaGoogleGeocoding(countryCode, postalCode) {
...
export async function lookupCityProvince(countryCode, postalCode) {
    ...
    if (google.city || google.provinceCode)
        return google;
